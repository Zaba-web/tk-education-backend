...
@section('title')
    Навчальні матеріали - {{$theme->title}} - Створити завдання
@endsection
...
<div class="content-wrapper">
    <small class='back-container'>
        ...
        <a href="{{url("/admin/education/theme/manage/{$theme->id}")}}" class='white'>Повернутись назад</a>
    </small>
    <br>
    <br>
    <br>
    <h1 class="dark">Навчальні матеріали - {{$theme->title}} - Створити завдання </h1>
    <p class="dark">
        На даній сторінці міститься вся інформація про поточні навчальні матеріали та всі необхідні, для керування ними, інструменти.
    </p>
    <form method="POST" action="{{url('admin/education/task/create')}}" v-on:submit="validateForm">
    @csrf
    <div class="no-bg-container">
        <div class="regular-block-full">
            ...
            <p>Заповніть форму із загальною інформацією про завдання.</p>
                <br>
                <input type="text" name='title' id="section-name" class="dark" placeholder=" " autocomplete="off" v-on:blur="validateInput" data-from='2' data-to='256' data-validate='false' data-field="Заголовок">
                <label for="section-name" class="dark">Введіть заголовок завдання</label>
                <br>
                <select name="theme_id"  class="dark">
                    <option value="{{$theme->id}}" class="dark" selected >{{$theme->title}}</option>
                </select>
                <br><br><br>
                ...
                <select name="publication_setting" class="dark">
                    ...
                    <option value="1" class="dark">Опублікувати</option>
                    <option value="2" class="dark">Чернетка</option>
                </select>
                <br><br><br>
                <span class='p-like'>Підсумкова робота:</span><input type="checkbox" name="summary_work" style='margin-left:10px;'>
        </div>
        <div class="regular-block-full">
            ...
            <details>
                ...
                <ul>
                    ...
                    <li>
                        Не слід використовувати додаткові шрифти, кольлори або змінювати розміри тексту.
                        <br>
                        <b>Виняток:</b> для введення коду можна застосувати шрифт Courier New.
                    </li>
    ...
    <button class="dashboard bright" type="submit"><span>Опублікувати</span></button>
</form>
</div>
@endsection
